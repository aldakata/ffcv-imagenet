...
do
    ...
    do
        for p in "${paths[@]}"
        do
            bash train_4local.sh 12MORE_RANDOM $opt /mnt/lustre/work/oh/owl156/data/$p 0 /mnt/lustre/work/oh/owl156/data/ImageNet4_8more_val_400_0.5_90.beton 12 3 3
        done
    done
done
...
#         for p in "${paths[@]}"
#         do
#             sbatch train_4.sbatch 12MOREGOOD $opt /mnt/lustre/work/oh/owl156/data/$p 0 /mnt/lustre/work/oh/owl156/data/ImageNet4_8more_val_400_0.5_90.beton 12 3
#         done
#     done
# done

# 12 SPURIOUSSPLIT
# paths=(12more_spurious_split_400_0.5_90_15.beton 12more_spurious_split_400_0.5_90_50.beton)
# for i in {0..10}
# do
#     for opt in adam
#     do
#         for p in "${paths[@]}"
#         do
#             sbatch train_4.sbatch 12SPURIOUSSPLITGOOD $opt /mnt/lustre/work/oh/owl156/data/$p 0 /mnt/lustre/work/oh/owl156/data/ImageNet4_8more_val_400_0.5_90.beton 12
#         done
#     done
# done